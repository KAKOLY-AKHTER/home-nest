...
//   return (
//     <div className="container mx-auto max-w-[1280px] md:py-30 py-70 px-4 ">
//       <div className="flex justify-between items-center mb-6">
//         <h2 className="text-3xl font-bold text-secondary">All Properties(<span className="text-cyan-400">{properties.length}</span>)</h2>
